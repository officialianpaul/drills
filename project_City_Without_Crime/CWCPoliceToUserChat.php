...
echo "<tr><td><font color='black' size='6'>Message to User</font></td><td><input type='text' name='txt_name2' size='40'></td></tr>";
...
$stat=$r[13]."<br>".@date("d/m/Y")."->".$_GET["txt_name2"];
if($firno>=1)
{
$q="UPDATE fir SET status='$stat',contact_no='$no',officer='$name' where s_no='$firno'";
$link=mysql_connect("localhost","root","");
mysql_select_db("soumya");
$res=mysql_query($q);   
