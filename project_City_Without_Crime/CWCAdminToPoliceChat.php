...
echo "<tr><td><font color='black' size='6'>Message to Police</font></td><td><input type='text' name='txt_name2' size='40'></td></tr>";
...
$stat=$r[18]."<br>".@date("d/m/Y")."->".$_GET["txt_name2"];
if($firno>=1)
{
$q="UPDATE fir SET atop='$stat' where s_no='$firno'";
$link=mysql_connect("localhost","root","");
mysql_select_db("soumya");
$res=mysql_query($q);   
